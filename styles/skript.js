if (document.body.id === "response_auf_mystery_form_page") {
...
if (document.body.id === 'naturwissenschaft_page') {
    ...
    audio.volume = 0.08; // Définit le volume à 10 % de sa capacité maximale
    audio.loop = true;
    ...
    btnsum.addEventListener('click', (e) => {
        ...
        if ((n1 == "") || (n2 == "")) {
            if ((isNaN(n1)) || (isNaN(n2))) {
                show.innerHTML = `Achtung!! nicht numerisches Feld und leeres Feldes vorhanden!! `;
                resetAlgebra();
                return 0;
            }
            ...
            show.innerHTML = `Achtung!! nicht numerisches Feld vorhanden`;
            resetAlgebra();
            return 0;
        }
